...
## 5 结果总表（7 runs + CI + ok 率；CI 均为 Wilson 95%，小样本如实标）

| # | run | n | acc | 95% CI | ok 率 | 分源 |
|---|---|---|---|---|---|---|
| T13 | 裸 190 | 190 | 138/190=72.6% | [65.9%, 78.5%] | 190/190 | JD40/60=66.7%[54.1,77.3] / FK42/60=70.0%[57.5,80.1] / CSDS56/70=80.0%[69.2,87.7] |
| T14-R1 | 复跑 off（同窗噪音基线） | 190 | 135/190=71.1% | — | 188/190（csds_0001/0002 DNS 失败记 ok=False） | JD39/60=65.0% / FK42/60=70.0% / CSDS54/70=77.1% |
| T14 | 场景 SCN | 190 | 141/190=74.2% | [67.6%, 79.9%] | 190/190 | JD42/60=70.0%[57.5,80.1] / FK43/60=71.7%[59.2,81.5] / CSDS56/70=80.0%[69.2,87.7] |
| T15 | 用户版 SCNv2 | 190 | 131/190=68.9% | [62.0%, 75.1%] | 190/190 | JD39/60=65.0%[52.4,75.8] / FK41/60=68.3%[55.8,78.7] / CSDS51/70=72.9%[61.5,81.9] |
| T16 | 硬子集 spam-only（06 难例 51） | 51 | 20/51=39.2% | [27.0%, 52.9%] | 51/51 | JD12/29=41.4%[25.5,59.3] / FK8/22=36.4%[19.7,57.0]；与 SCNv2-spam 子集同 id 0 翻转 |
...
T16 的 39.2% 系难例富集（gold 垃圾 41/正常 10，pred 垃圾 12/正常 39，偏向判正常），
与全量口径不直接对标。全部 CI 重叠，不作显著性断言。
